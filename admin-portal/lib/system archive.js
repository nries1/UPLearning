...
function scheduledSystemArchive() {
  var databases = SpreadsheetApp.openById("15Gv1ZbjUX2ZGSUOPBIUfDlo8jRod4DgwYoy2WLnmVoo").getSheets().map(function (sheet) {
    var obj = {};
...
function archiveSystem(instance) {
  ...
  try {
    ...
    MailApp.sendEmail(instance.dm_email, "System Archive Report", "Hello,\n\nThe PL System archive for instance " + instance.instance_name + " was archived to a new spreadsheet.\
     ...
     Your current working archive is here (this will always be the same spreadsheet): " + DriveApp.getFileById(instance.archive_id).getUrl(), {
      cc: "nries@schools.nyc.gov"
    });
    ...
    MailApp.sendEmail(instance.dm_email, "Error archiving your archive", "Something went wrong while trying to archive your working archive.\n\nError: " + error + "\n\nPlease make sure that your PL System Archive Current file and its parent folder are shared for editing with professionallearning@strongschools.nyc", {
      cc: "nries@schools.nyc.gov"
    });
  }
}