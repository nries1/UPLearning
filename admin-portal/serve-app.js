function doGet(e) {
  ...
  return HtmlService.createTemplateFromFile('admin-portal')
      .evaluate().setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL)
  .setFaviconUrl("https://www.schools.nyc.gov/favicon.ico").setTitle("Admin Portal").addMetaTag('viewport', 'width=device-width, initial-scale=1');
  }
}
